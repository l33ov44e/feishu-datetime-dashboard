...
body, body[theme-mode=dark] .semi-always-light {
  ...
  --semi-blue-0: 235,242,254;
  --semi-blue-1: 206,223,252;
  --semi-blue-2: 158,190,249;
  --semi-blue-3: 111,156,246;
  --semi-blue-4: 65,121,243;
  --semi-blue-5: 20,86,240;
  --semi-blue-6: 11,66,204;
  --semi-blue-7: 4,48,169;
  --semi-blue-8: 0,33,133;
  --semi-blue-9: 0,23,97;
  ...
  --semi-green-1: 208,240,208;
  --semi-green-2: 164,225,167;
  --semi-green-3: 125,209,130;
  --semi-green-4: 90,194,98;
  --semi-green-5: 59,179,70;
  --semi-green-6: 48,149,59;
  --semi-green-7: 37,119,47;
  --semi-green-8: 27,90,36;
  --semi-green-9: 17,60,24;
  --semi-feishu-0: 235,242,254;
  --semi-feishu-1: 206,223,252;
  --semi-feishu-2: 158,190,249;
  --semi-feishu-3: 111,156,246;
  --semi-feishu-4: 65,121,243;
  --semi-feishu-5: 20,86,240;
  --semi-feishu-6: 11,66,204;
  --semi-feishu-7: 4,48,169;
  --semi-feishu-8: 0,33,133;
  --semi-feishu-9: 0,23,97;
  ...
  --semi-purple-1: 239,203,240;
  --semi-purple-2: 221,155,225;
  --semi-purple-3: 201,112,209;
  --semi-purple-4: 180,74,194;
  --semi-purple-5: 158,40,179;
  --semi-purple-6: 135,31,159;
  --semi-purple-7: 113,23,138;
  --semi-purple-8: 92,16,118;
...
body[theme-mode=dark], body .semi-always-dark {
  ...
  --semi-red-0: 106,1,3;
  --semi-red-1: 142,8,5;
  --semi-red-2: 178,20,12;
  --semi-red-3: 213,37,21;
  --semi-red-4: 249,57,32;
  --semi-red-5: 250,102,76;
  --semi-red-6: 251,144,120;
  --semi-red-7: 253,183,165;
  --semi-red-8: 254,221,210;
  --semi-red-9: 254,242,237;
  --semi-white: 255,255,255;
  --semi-blue-0: 4,26,100;
  --semi-blue-1: 9,40,136;
  --semi-blue-2: 17,58,172;
  --semi-blue-3: 26,77,207;
  --semi-blue-4: 20,86,240;
  --semi-blue-5: 80,132,245;
  --semi-blue-6: 122,164,248;
  --semi-blue-7: 166,195,250;
  --semi-blue-8: 210,226,253;
  --semi-blue-9: 237,244,254;
  --semi-cyan-0: 0,50,61;
  --semi-cyan-1: 0,77,91;
  --semi-cyan-2: 1,105,121;
  --semi-cyan-3: 3,134,152;
  --semi-cyan-4: 5,164,182;
  --semi-cyan-5: 44,184,197;
  --semi-cyan-6: 88,203,211;
  --semi-cyan-7: 138,221,226;
  --semi-cyan-8: 194,239,240;
  ...
  --semi-lime-0: 47,70,0;
  --semi-lime-1: 72,104,0;
  --semi-lime-2: 99,139,0;
  --semi-lime-3: 126,174,0;
  --semi-lime-4: 155,209,0;
  --semi-lime-5: 167,218,44;
  --semi-lime-6: 183,227,91;
  --semi-lime-7: 203,237,142;
  --semi-lime-8: 227,246,197;
  --semi-lime-9: 242,250,230;
  --semi-pink-0: 90,1,43;
  --semi-pink-1: 126,5,58;
  --semi-pink-2: 162,11,72;
  --semi-pink-3: 197,19,86;
  --semi-pink-4: 233,30,99;
  --semi-pink-5: 237,72,123;
  --semi-pink-6: 242,115,150;
  --semi-pink-7: 246,160,181;
  --semi-pink-8: 251,207,216;
  --semi-pink-9: 253,236,239;
  --semi-teal-0: 0,60,58;
  --semi-teal-1: 0,90,85;
  --semi-teal-2: 0,119,111;
  --semi-teal-3: 0,149,137;
  --semi-teal-4: 0,179,161;
  --semi-teal-5: 39,194,176;
  --semi-teal-6: 84,209,193;
  --semi-teal-7: 135,225,211;
  --semi-teal-8: 192,240,232;
  --semi-teal-9: 228,247,244;
  --semi-amber-0: 81,46,9;
  --semi-amber-1: 122,75,15;
  --semi-amber-2: 162,108,22;
  --semi-amber-3: 203,144,30;
  --semi-amber-4: 240,177,20;
  --semi-amber-5: 245,203,80;
  --semi-amber-6: 248,220,122;
  --semi-amber-7: 250,234,166;
  --semi-amber-8: 253,246,210;
  --semi-amber-9: 254,252,237;
  ...
  --semi-green-0: 17,60,24;
  --semi-green-1: 27,90,36;
  --semi-green-2: 37,119,47;
  --semi-green-3: 48,149,59;
  --semi-green-4: 59,179,70;
  --semi-green-5: 90,194,98;
  --semi-green-6: 125,209,130;
  --semi-green-7: 164,225,167;
  --semi-green-8: 208,240,208;
  --semi-green-9: 236,247,236;
  --semi-indigo-0: 23,29,99;
  --semi-indigo-1: 31,40,120;
  --semi-indigo-2: 40,52,140;
  --semi-indigo-3: 51,66,161;
  --semi-indigo-4: 63,81,181;
  --semi-indigo-5: 94,111,196;
  --semi-indigo-6: 128,144,211;
  --semi-indigo-7: 167,179,225;
  --semi-indigo-8: 209,216,240;
  --semi-indigo-9: 236,239,248;
  --semi-orange-0: 84,29,0;
  --semi-orange-1: 126,49,0;
  --semi-orange-2: 168,74,0;
  --semi-orange-3: 210,103,0;
  --semi-orange-4: 252,136,0;
  --semi-orange-5: 253,166,51;
  --semi-orange-6: 253,193,101;
  --semi-orange-7: 254,217,152;
  --semi-orange-8: 254,238,204;
  --semi-orange-9: 255,248,234;
  --semi-purple-0: 73,10,97;
  --semi-purple-1: 92,16,118;
  --semi-purple-2: 113,23,138;
  --semi-purple-3: 135,31,159;
  --semi-purple-4: 158,40,179;
  --semi-purple-5: 180,74,194;
  --semi-purple-6: 201,112,209;
  --semi-purple-7: 221,155,225;
  --semi-purple-8: 239,203,240;
  --semi-purple-9: 247,233,247;
  --semi-violet-0: 40,20,117;
  --semi-violet-1: 54,28,138;
  --semi-violet-2: 70,37,158;
  --semi-violet-3: 87,47,179;
  --semi-violet-4: 106,58,199;
  --semi-violet-5: 136,91,210;
  --semi-violet-6: 166,127,221;
  --semi-violet-7: 196,167,233;
  --semi-violet-8: 226,209,244;
  --semi-violet-9: 243,237,249;
  --semi-yellow-0: 83,72,0;
  --semi-yellow-1: 125,106,0;
  --semi-yellow-2: 167,139,0;
  --semi-yellow-3: 208,170,0;
  --semi-yellow-4: 250,200,0;
  --semi-yellow-5: 251,218,50;
  --semi-yellow-6: 252,232,101;
  --semi-yellow-7: 253,243,152;
  --semi-yellow-8: 254,251,203;
  --semi-yellow-9: 255,253,234;
  --semi-light-blue-0: 0,53,95;
  --semi-light-blue-1: 0,75,131;
  --semi-light-blue-2: 0,99,167;
  --semi-light-blue-3: 0,123,202;
  --semi-light-blue-4: 0,149,238;
  --semi-light-blue-5: 48,172,241;
  --semi-light-blue-6: 98,195,245;
  --semi-light-blue-7: 149,216,248;
  --semi-light-blue-8: 201,236,252;
  --semi-light-blue-9: 233,247,253;
  --semi-light-green-0: 37,61,18;
  --semi-light-green-1: 57,91,27;
  --semi-light-green-2: 78,121,38;
  --semi-light-green-3: 100,152,48;
  --semi-light-green-4: 123,182,60;
  --semi-light-green-5: 147,197,91;
  --semi-light-green-6: 173,211,126;
  --semi-light-green-7: 200,226,165;
  --semi-light-green-8: 227,240,208;
...
body, body[theme-mode=dark] .semi-always-light {
  ...
  --semi-color-info: rgba(20,86,240,1);
  --semi-color-link: rgba(20,86,240,1);
  ...
  --semi-color-fill-1: rgba(31,35,41,0.1);
  --semi-color-fill-2: rgba(217,220,223,1);
  --semi-color-text-0: rgba(31,35,41,1);
  --semi-color-text-1: rgba(31,35,41,0.8);
  --semi-color-text-2: rgba(100,106,115,0.6);
  --semi-color-text-3: rgba(143,149,158,0.35);
  ...
  --semi-color-fill-000: rgba(255,255,255,0);
  --semi-color-shadow: rgba(var(--semi-black), 0.04);
  --semi-color-stroke: rgba(208,211,214,1);
  --semi-color-default: rgba(var(--semi-grey-0), 1);
  --semi-color-info-hover: rgba(11,66,204, 1);
  --semi-color-link-hover: rgba(51,109,244,1);
  --semi-color-primary: rgba(20,86,240,1);
  --semi-color-success: rgba(var(--semi-green-5), 1);
  --semi-color-warning: rgba(var(--semi-orange-5), 1);
  --semi-color-info-active: rgba(4,48,169, 1);
  --semi-color-link-active: rgba(4,66,210,1);
  --semi-color-link-visited: rgba(20,86,240, 1);
  --semi-color-tertiary: rgba(var(--semi-grey-5), 1);
  --semi-color-focus-border: rgba(var(--semi-brand-5), 1);
  --semi-color-info-disabled: rgba(158,190,249, 1);
  --semi-color-overlay-bg: rgba(22, 22, 26, 0.6);
  --semi-color-danger-hover: rgba(var(--semi-red-6), 1);
  --semi-color-highlight: rgba(var(--semi-black), 1);
  --semi-color-secondary: rgba(var(--semi-light-blue-5), 1);
  --semi-color-stroke-hover: rgba(168,173,178, 1);
  --semi-color-danger-active: rgba(var(--semi-red-7), 1);
  --semi-color-disabled-bg: rgba(var(--semi-grey-1), 1);
  --semi-color-stroke-active: rgba(130,136,143, 1);
  --semi-color-default-hover: rgba(var(--semi-grey-1), 1);
  --semi-color-primary-hover: rgba(51,109,244,1);
  ...
  --semi-color-primary-active: rgba(4,66,210,1);
  --semi-color-stroke-disabled: rgba(237,239,240, 1);
  --semi-color-success-active: rgba(var(--semi-green-7), 1);
  --semi-color-warning-active: rgba(var(--semi-orange-7), 1);
  --semi-color-tertiary-hover: rgba(var(--semi-grey-6), 1);
  --semi-color-disabled-border: rgba(var(--semi-grey-1), 1);
  --semi-color-primary-disabled: rgba(187,191,196,1);
  --semi-color-success-disabled: rgba(var(--semi-green-2), 1);
  --semi-color-tertiary-active: rgba(var(--semi-grey-7), 1);
  --semi-color-secondary-hover: rgba(var(--semi-light-blue-6), 1);
  --semi-color-secondary-active: rgba(var(--semi-light-blue-7), 1);
  --semi-color-info-light-hover: rgba(252,253,255, 1);
  --semi-color-info-light-active: rgba(249,251,255, 1);
  --semi-color-secondary-disabled: rgba(var(--semi-light-blue-2), 1);
  --semi-color-info-light-default: rgba(240,244,255,1);
...
body[theme-mode=dark], body .semi-always-dark {
  ...
  --semi-color-text-0: rgba(235,235,235,1);
  --semi-color-text-1: rgba(235,235,235,0.8);
  --semi-color-text-2: rgba(166,166,166,0.6);
  --semi-color-text-3: rgba(117,117,117,0.35);
  ...
  --semi-color-secondary: rgba(var(--semi-light-blue-5), 1);
  --semi-color-stroke-hover: rgba(76,136,255,1);
  --semi-color-danger-active: rgba(var(--semi-red-7), 1);
  --semi-color-disabled-bg: rgba(var(--semi-grey-1), 1);
  --semi-color-stroke-active: rgba(76,136,255,1);
  --semi-color-default-hover: rgba(var(--semi-grey-1), 1);
  --semi-color-primary-hover: rgba(39,95,206,1);
  --semi-color-success-hover: rgba(var(--semi-green-6), 1);
  --semi-color-warning-hover: rgba(var(--semi-orange-6), 1);
  --semi-color-default-active: rgba(var(--semi-grey-2), 1);
  --semi-color-disabled-fill: rgba(var(--semi-grey-8), 0.04);
  ...
  --semi-color-primary-active: rgba(76,136,255,1);
  --semi-color-stroke-disabled: rgba(80,80,80,1);
  --semi-color-success-active: rgba(var(--semi-green-7), 1);
  --semi-color-warning-active: rgba(var(--semi-orange-7), 1);
  --semi-color-tertiary-hover: rgba(var(--semi-grey-6), 1);
  --semi-color-disabled-border: rgba(var(--semi-grey-1), 1);
  --semi-color-primary-disabled: rgba(95,95,95,1);
  --semi-color-success-disabled: rgba(var(--semi-green-2), 1);
  --semi-color-tertiary-active: rgba(var(--semi-grey-7), 1);
  --semi-color-secondary-hover: rgba(var(--semi-light-blue-6), 1);
  --semi-color-secondary-active: rgba(var(--semi-light-blue-7), 1);
...
.semi-button-borderless:not(.semi-button-disabled):hover {
  background-color: var(--semi-color-fill-1);
  border: 0 var(--semi-color-fill-000) solid;
}
...
.semi-button-light {
  background-color: var(--semi-color-fill-000);
  border: 1px var(--semi-color-stroke) solid;
  transition: background-color var(--semi-transition_duration-none) var(--semi-transition_function-easeIn) var(--semi-transition_delay-none), border var(--semi-transition_duration-none) var(--semi-transition_function-easeIn) var(--semi-transition_delay-none);
  transform: scale(var(--semi-transform_scale-none));
}
...
.semi-button-light:not(.semi-button-disabled):active {
  background-color: var(--semi-color-fill-000);
  border: 1px var(--semi-color-primary-active) solid;
}
...
.semi-input-wrapper-focus {
  background-color: var(--semi-color-fill-000);
  border: var(--semi-color-primary) solid 1px;
}
...
.semi-input-wrapper-error:hover {
  background-color: var(--semi-color-danger-light-default);
  border-color: var(--semi-color-danger-hover);
}
.semi-input-wrapper-error.semi-input-wrapper-focus {
  background-color: var(--semi-color-danger-light-default);
  border-color: var(--semi-color-danger-active);
}
...
.semi-input-wrapper-warning:hover {
  background-color: var(--semi-color-warning-light-default);
  border-color: var(--semi-color-warning-hover);
}
...
.semi-input-append {
  border-radius: 0 6px 6px 0;
  border-left: 1px var(--semi-color-stroke) solid;
}
.semi-input-prepend {
  border-radius: 6px 0 0 6px;
  border-right: 1px var(--semi-color-stroke) solid;
}
...
.semi-switch:active {
  border: 1px var(--semi-color-fill-1) solid;
}
...
.semi-tagInput-warning.semi-tagInput-focus {
  background-color: var(--semi-color-warning-light-default);
  border-color: var(--semi-color-warning-active);
}
.semi-tagInput-error {
  background-color: var(--semi-color-danger-light-default);
  border-color: var(--semi-color-danger-light-hover);
