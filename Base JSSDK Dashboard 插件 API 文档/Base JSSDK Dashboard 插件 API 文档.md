...
* 当你在 Next.js 项目中使用 Semi 时，需要搭配 Semi 提供的编译插件（由于 Next.js 不允许 npm 包从 node\_modules 中 import 样式文件，需要配合插件将默认的import CSS 语句移除，并且手动引入 CSS）
...
* 仓库地址：
  ...
  * Github: https://github.com/Lark-Base-Team/radar\_chart\_demo

  * Replit: https://replit.com/@lark-base/radarchartdemo

* 预览链接：https://ext.baseopendev.com/ext/radar\_chart\_demo/20725d33fa44b1e1ba41c78bacb2e0c1e37828b2/index.html
...
图表**首次添加**至仪表盘时，插件处于创建状态，创建状态下插件相关数据并未落库，因此无法调用 [getConfig](https://bytedance.larkoffice.com/docx/IahqdOrCto2xAKxPV7Oc8gyenfg#B0Kvdrloto7csKxKyV2cXWZIn7f) 和 [getData](https://bytedance.larkoffice.com/docx/IahqdOrCto2xAKxPV7Oc8gyenfg#VGerd9tl0obF3nxP8YDczwirnVf) 方法。除了初始化逻辑存在差异，创建状态和配置状态逻辑基本一致。

## **配置状态**

![](images/20231254-1.png)

![](images/20231255.png)

在配置状态下用户可以对右侧配置进行修改，**插件左侧图表需要跟随右侧配置的变更实时渲染**，渲染数据可通过 [getPreviewData](https://bytedance.larkoffice.com/docx/IahqdOrCto2xAKxPV7Oc8gyenfg#Mun3dJ3JtoLhVpxspi6cB3Ekn2b) 接口进行获取。

## 展示状态

![](<images/20231257 (2).png>)

![](<images/20231257 (3).png>)
...
当前插件所处的状态，具体请参考[仪表盘插件状态](https://bytedance.larkoffice.com/docx/IahqdOrCto2xAKxPV7Oc8gyenfg#AJKZda3tEoECdixfF0jc5lTvnac)中的描述。
